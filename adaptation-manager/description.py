...
'/usr/local/lib/python2.7/dist-packages/nupic-1.0.1.dev0-py2.7.egg/nupic/swarming/exp_generator/experiment_generator.pyc'
"""
...
control = {
  ...
  #
  'dataset' : {   u'info': u'cpu',
        u'streams': [   {   u'columns': [u'*'],
                            u'info': u'cpu.csv',
                            u'source': u'file://cpu.csv'}],
        u'version': 1},
 ...
 u'predictedField': u'cpu',
 u'predictionSteps': [1]},

  # Metrics: A list of MetricSpecs that instantiate the metrics that are
  # computed for this experiment
  'metrics':[
    MetricSpec(field=u'cpu', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'aae'}),
    MetricSpec(field=u'cpu', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'altMAPE'})
  ],
